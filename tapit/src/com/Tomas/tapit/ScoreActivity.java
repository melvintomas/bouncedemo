...
public class ScoreActivity extends Activity{
	...
	protected void onStart() {
		...
		((TextView) findViewById(R.id.scoreDisplay)).setText("Your Score: " + getIntent().getExtras().getInt("score"));
	...
	public void post(View v){
		ProgressDialog progressDialog = ProgressDialog.show(this, "Posting to Facebook", "Please wait ...", true);
	        ...
	        try {	           
	                ...
	                parameters.putString("message", "I just earned " + score[position+4] + " points. A new high score!");
	                parameters.putString("icon", "http://emjebity.com/images/icon.gif");
	                parameters.putString("picture", "http://emjebity.com/images/images.gif");
	                parameters.putString("description", "Tap it! is a work-in-progress game. Coming soon to a Play Store near you!");
